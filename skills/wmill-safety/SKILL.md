...
The safety rules above are guidance that Claude follows voluntarily. For hard enforcement that blocks dangerous commands even if bypassed, install the hooks from the `sieteunoseis/hooks` repository.

**Source:** [hooks/windmill-safety](https://github.com/sieteunoseis/hooks/tree/master/hooks/windmill-safety)
